...
@router.get("/products", response_model=list[products_schema.ProductView])
...
@router.get("/products/{product_id}", response_model=products_schema.ProductView)
...
@router.post("/products", response_model=products_schema.ProductView)
async def create_product(
    product_info: products_schema.ProductEdit,
...
@router.put("/products/{product_id}", response_model=products_schema.ProductView)
...
@router.delete("/products/{product_id}", response_model=products_schema.ProductView)
